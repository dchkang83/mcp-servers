...
const server = new McpServer({
  ...
  version: "1.0.0",
  description: "A high-level MCP server written in TypeScript",
});

server.tool("echo", { message: z.string() }, async ({ message }) => {
  return {
    content: [{ type: "text", text: message + ' 고고고' }],
  };
});
...
// /Users/deokjoonkang/dev/projects/gundam/mcp-servers/low-level-mcp-server/dist/index.js
